...
const Hero = () => {
  ...
  const combinedImageY = useTransform(
    scrollYProgress,
    [0, 1],
    [isMobile ? 0 : mousePos.y * 20, isMobile ? -160 : mousePos.y * 20],
  );
  ...
  return (
    <div
      ref={containerRef}
      className="relative h-[200vh] md:h-auto w-full overflow-visible"
    >
      <section
        id="hero"
        className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-between pt-24 pb-0 px-0 md:relative md:top-auto md:h-full md:min-h-screen md:pt-28 md:pb-12 md:px-12 xl:px-24"
        style={{
          background:
